...
export default function Projects() {
  ...
  return (
    <>
      <section>
        <h2 className="text-7xl text-center translate-y-24">our Projects</h2>

        <div className="images grid grid-cols-1 md:grid-cols-3 gap-4 p-4 w-full max-w-4xl mx-auto mt-20">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
          <div className="relative bg-white rounded-lg overflow-hidden">
            <img src={currentImage} alt="Project" className="max-w-full max-h-screen" />
            <button
              onClick={closeModal}
