...
export default function Navbar() {
  ...
  return (
    <>
    <nav className={`${isScrolling ==false?"p-2 md:p-6" : "md:p-2 p-1" } transition-all duration-[400ms] z-50 flex justify-between items-cente bg-white  md:px-20 text-black font-bold fixed top-0 right-0 left-0 md:right-14 md:left-14 border-2 md:rounded-b-2xl rounded-b-lg`}>
